...
if( !function_exists('mate_mix_grid_posts') ):

    function mate_mix_grid_posts( $twp_mate_home_section ){
		...
		$featured_posts_query = new WP_Query( array('post_type' => 'post', 'posts_per_page' => 4,'post__not_in' => get_option("sticky_posts"), 'category_name' => $category ) );
	    ...
	    if( $featured_posts_query->have_posts() ): ?>
	        ...
	        <section class="theme-section theme-panel-section">
	            <div class="wrapper">
	                ...
	                <div class="wrapper-inner">
	                    ...
	                    <div class="column column-6 column-sm-12">
	                        ...
	                        while( $featured_posts_query->have_posts() ):
	                            ...
	                            <article id="post-<?php the_ID(); ?>" <?php post_class('theme-listmain-article'); ?>>
	                                <div class="article-area article-height-large article-heading-big">
                                                            ...
                                                            <div class="entry-details">
                                                               ...
                                                               <?php if( $ed_category_meta != 'hide-cat' ){ ?>
	                                                            ...
	                                                            <?php if( $ed_excerpt_content != 'no' ){ ?>
																    ...
																    <div class="entry-content theme-entry-content entry-content-small">
