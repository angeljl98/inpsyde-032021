...
<div class="wrap">
	...
	?>
	<div class="dik-content dik-default-content">
			...
			<div class="dik-default-main">
						...
						<div class="uploader-inline-content no-upload-message">
							...
							<div class="upload-ui">
								...
								<div class="twp-upload-btn-wrapper">
									<button type="button" class="browser button button-hero twp-btn-uploader" id="__wp-uploader-id-1" style="display: inline-block; position: relative; z-index: 1;"><?php esc_html_e('Select Files','demo-import-kit') ?></button>
									<input type="file" class="twp-content-upload-default" name="twp-content-file-upload" id="twp-content-file-upload">
								</div>
							</div>
				...
				<div class="dik-no-grid-view">
					...
					<button class="button button-primary" id="twp-zip-file-upload"><?php esc_html_e('Import','demo-import-kit') ?></button>
	...
	<?php }else{ ?>
		...
		<div class="dik-content dik-advanced-content">
			...
			<?php if( $import_files_array || $secondary_cat_array ){ ?>
				...
				<div class="dik-content-wrapper <?php if( !$secondary_cat_array ){ echo 'dik-no-secondary-cat'; } ?>">
		            ...
		            <?php if( $import_files_array ){ Demo_Import_Kit_Base_Class::demo_import_kit_secondary_tab_render( $secondary_cat_array ); } ?>
