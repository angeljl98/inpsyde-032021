...
class Plf_setting {
    ...
    <div class="grid-row">
      ...
      <?php } ?> 
      <?php if(! is_plugin_active('yasakani-cache/yasakani-cache.php')){ ?>
        <div style="background-color: #f0fff0; border:1px solid #70c370; padding:4px 20px; margin: 10px 0;" >
         <p><strong><?php _e('Introduction of YASAKANI Cache', 'plf'); ?></strong></p>
         <p><?php _e('We offer Free Cache Plugin that is very easy to use and very fast.', 'plf'); ?></p>
         <p><?php _e('See more information ', 'plf'); ?><a target="_blank" rel="noopener" href="https://celtislab.net/en/wp-yasakani-cache/"> YASAKANI Cache</a></p>
         <p><?php _e('We also sell Addon for Image Optimization, so please consider using them!', 'plf'); ?></p>
         <p><?php _e('See more information ', 'plf'); ?><a target="_blank" rel="noopener" href="https://celtislab.net/en/wp-yasakani-cache-img-optimizer-addon/"> YASAKANI Image Optimizer</a></p>
        </div>
      <?php } ?>           
      </div>
    </div>
